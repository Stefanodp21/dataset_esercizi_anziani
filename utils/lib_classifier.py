...
'''
    ...
    def train(self, X, Y):
        ...
        '''
        scores = cross_val_score(self.clf, X, Y, cv = 10, scoring = 'accuracy')
        print (scores)
        print (scores.mean())
        '''
    ...
    def _init_all_models(self):
        ...
        self.classifiers = [
            ...
            RandomForestClassifier(
                max_depth=10, n_estimators=100, max_features="auto"),
            MLPClassifier(hidden_layer_sizes=(8,8,8), activation='relu', solver='adam', max_iter=500),  # Neural Net
            AdaBoostClassifier(),
            GaussianNB(),
...
class ClassifierOnlineTest(object):
    ...
    def __init__(self, model_path, action_labels, window_size, human_id=0):
        ...
        #maggiore di 0.9 compare l'etichetta
        self.THRESHOLD_SCORE_FOR_DISP = 0.9
