...
def draw_result_img(img_disp, humans, skeleton_detector,
    ...
    for i in range(-1, len(CLASSES)):
        ...
        cv2.putText(img_disp, text=s, org=(TXT_X, TXT_Y),
                    fontFace=cv2.FONT_ITALIC, fontScale=FONT_SIZE,
    ...
    try:
        ...
        while images_loader.has_image():
            ...
            if len(dict_id2skeleton):
                ...
                if(new_label_class == "neck" and change_label == True):
                    change_label = False
                #if(new_label_class == "neck" and change_label == True):
                    #change_label = False
                #if(new_label_class == "hip" and change_label == True):
                    #change_label = False
                if(new_label_class == "foldedLegs" and 
                    ...
                    change_label = False
                elif((new_label_class == "cross" or new_label_class == "arms" 
